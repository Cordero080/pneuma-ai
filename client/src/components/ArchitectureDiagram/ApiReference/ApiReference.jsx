...
const ApiReference = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      color: "#b400ff",
      files: [
        "archetypes/archetypeDepth.js",
        "intelligence/archetypeSelector.js",
      ],
    },
    {
      id: "cat-synthesis",
    ...
    <div className="api-reference">
      ...
      <div className="api-section">
        ...
        <div className="quick-links">
          <div
            ...
            onClick={() => setActiveModal("data-flow")}
          >
            Data Flow Overview
          </div>
          <div
            className="quick-link"
            onClick={() => setActiveModal("file-structure")}
          >
            File Structure
          </div>
          <div
            className="quick-link"
            onClick={() => setActiveModal("token-budget")}
          >
            Token Budget
          </div>
        </div>
      ...
      >
        <ModalSection title="Overview">
          <ModalDesc>
            Pneuma uses Anthropic's Claude claude-sonnet-4-20250514 as its core
            language model. This is the "brain" that generates responses after
            receiving the fully assembled system prompt.
          </ModalDesc>
        </ModalSection>
...
const response = await anthropic.messages.create({
  ...
  stream: true
        ...
        <ModalSection title="Key Parameters">
          <ModalFlow
            steps={[
              {
                title: "model",
                desc: "claude-sonnet-4-20250514 - Balanced speed and quality",
              },
              {
                title: "max_tokens",
                desc: "1200 - Typical response length limit",
              },
              {
                title: "temperature",
                desc: "0.85 - High for creative responses",
              },
              {
                title: "stream",
                desc: "true - Enables token-by-token streaming",
              },
            ]}
          />
        </ModalSection>
        ...
        <ModalSection title="Cost">
          <ModalDesc>
            ~$0.003 per input token, ~$0.015 per output token. Average
            conversation turn costs roughly $0.01-0.03.
          </ModalDesc>
        </ModalSection>
      </Modal>
      ...
      >
        <ModalSection title="Overview">
          <ModalDesc>
            Used for converting text into vector embeddings. These vectors
            enable semantic search across memories and archetype knowledge.
          </ModalDesc>
        </ModalSection>
        ...
        <ModalSection title="Use Cases">
          <ModalFlow
            steps={[
              {
                title: "Memory Search",
                desc: "Find relevant past conversations by semantic similarity",
              },
              {
                title: "Archetype Matching",
                desc: "Route messages to appropriate archetypes",
              },
              {
                title: "RAG Retrieval",
                desc: "Find relevant archetype knowledge passages",
              },
            ]}
          />
        </ModalSection>
      ...
      >
        <ModalSection title="Overview">
          <ModalDesc>
            ...
            It receives requests from the React frontend and orchestrates the
            response pipeline.
          </ModalDesc>
        </ModalSection>
    ...
    proxy: {
      ...
      >
        <ModalSection title="Purpose">
          <ModalDesc>
            Handles incoming requests and orchestrates the overall flow. The
            conductor that coordinates all other layers.
          </ModalDesc>
        </ModalSection>
            ...
            steps={[
              {
                ...
                desc: "Parse incoming message from frontend",
              },
              {
                title: "Load State",
                desc: "Retrieve current Pneuma state and context",
              },
              {
                title: "Invoke Pipeline",
                desc: "Call into intelligence and archetype layers",
              },
              {
                title: "Return Response",
                desc: "Stream response back to client",
              },
            ]}
          />
        </ModalSection>
      ...
      >
        <ModalSection title="Purpose">
          <ModalDesc>
            The analytical engine that understands user intent, selects
            appropriate tones, and interfaces with Claude for response
            generation.
          </ModalDesc>
        </ModalSection>
        <ModalSection title="Key Files">
            ...
            steps={[
              {
                ...
                desc: "Score message across 8 intent dimensions",
              },
              {
                title: "Tone Selection",
                desc: "Choose from 6 tones based on intent weights",
              },
              {
                title: "LLM Interface",
                desc: "Build prompts and call Claude API",
              },
              {
                title: "Post-Processing",
                desc: "Refine responses through 4-layer pipeline",
              },
            ]}
          />
        </ModalSection>
            ...
            steps={[
              {
                ...
                desc: "6 methods choose 3-4 archetypes per response",
              },
              {
                title: "Depth Extraction",
                desc: "Pull 5 layers of insight per archetype",
              },
              {
                title: "Collision Detection",
                desc: "Identify productive philosophical tensions",
              },
              {
                title: "RAG Retrieval",
                desc: "Fetch relevant passages from archetype knowledge",
              },
            ]}
          />
        </ModalSection>
      ...
      >
        <ModalSection title="Purpose">
          <ModalDesc>
            When archetypes conflict (Nietzsche's will vs Lao Tzu's wu wei),
            this layer doesn't pick a winner—it synthesizes them into emergent
            insight.
          </ModalDesc>
        </ModalSection>
        <ModalSection title="Key Files">
          <ModalFilePath path="server/pneuma/intelligence/synthesisEngine.js" />
          <ModalFilePath path="server/pneuma/intelligence/synthesisExemplars.js" />
        </ModalSection>
        <ModalSection title="Responsibilities">
          <ModalFlow
            steps={[
              {
                ...
                desc: "Identify where archetypes conflict (high/medium) or converge (low)",
              },
              {
                title: "Collision Directive",
                desc: "High/medium tension: inject synthesis instruction to dwell in the friction",
              },
              {
                title: "Resonance Directive",
                desc: "Low tension: inject convergence instruction to find the view only available from both positions",
              },
              {
                title: "Synthesis Exemplars",
                desc: "Pre-written exemplars from synthesisExemplars.js shown to Claude alongside each directive — demonstrating the shape of emergent thinking, not just the instruction",
              },
            ]}
          />
        </ModalSection>
      ...
      >
        <ModalSection title="Purpose">
          <ModalDesc>
            Pneuma remembers. Vector memory enables semantic search across
            conversations. Long-term memory persists insights across sessions.
            This is what makes Pneuma feel like a continuous relationship, not
        ...
        <ModalSection title="Responsibilities">
          <ModalFlow
            steps={[
              {
                title: "Embedding",
                desc: "Convert text to vectors for semantic search",
              },
              {
                title: "Similarity Search",
                desc: "Find relevant past conversations",
              },
              {
                title: "Context Injection",
                desc: "Add memories to conversation context",
              },
              {
                title: "Persistence",
                desc: "Store important insights across sessions",
              },
            ]}
          />
        </ModalSection>
      ...
      >
        <ModalSection title="Purpose">
          <ModalDesc>
            The final stage—assembling everything into coherent response,
            streaming it to the user, and persisting state changes.
          </ModalDesc>
        </ModalSection>
        <ModalSection title="Key Files">
          <ModalFilePath path="server/pneuma/core/responseEngine.js" />
            ...
            steps={[
              {
                ...
                desc: "Combine identity + archetypes + synthesis + context",
              },
              {
                title: "Stream Response",
                desc: "Token-by-token delivery via SSE",
              },
              {
                title: "State Update",
                desc: "Persist momentum, mood, conversation history",
              },
              {
                title: "Memory Storage",
                desc: "Embed and store significant exchanges",
              },
            ]}
          />
        </ModalSection>
        ...
        <ModalSection>
          <ModalFlow
            steps={[
              {
                title: "User Input",
                desc: "React → POST /api/message → Express",
              },
              {
                title: "Orchestration",
                desc: "fusion.js loads state, checks modes",
              },
              {
                title: "Intent Detection",
                desc: "responseEngine.js scores 8 intents",
              },
              {
                title: "Tone Selection",
                desc: "Weighted selection from 6 tones",
              },
              {
                title: "Archetype Selection",
                desc: "6 methods pick 3-4 archetypes",
              },
              { title: "Collision Check", desc: "Detect productive tensions" },
              {
                title: "Depth Extraction",
                desc: "Pull 5 layers per archetype",
              },
              {
                title: "Synthesis",
                desc: "If collision, inject synthesis directive",
              },
              {
                title: "Archetype RAG",
                desc: "Retrieve passages from 46 knowledge bases",
              },
              {
                title: "Prompt Assembly",
                desc: "Combine all into system prompt",
              },
...
│   ├── archetypeSelector.js  # Vector-based routing (+ evolution bias)
│   ├── synthesisEngine.js # Collision + resonance detection
│   └── synthesisExemplars.js # Pre-written collision/resonance exemplars
├── archetypes/
    ...
    └── archetypes.js      # Archetype definitions`}</ModalCodeBlock>
      ...
      >
        <ModalSection title="Claude Context Window">
          <ModalDesc>
            Claude claude-sonnet-4-20250514 has a 200K token context window, but
            Pneuma aims to keep prompts under 6K for cost and speed.
          </ModalDesc>
        </ModalSection>
